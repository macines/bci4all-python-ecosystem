...
Nota:
    O sys.executable abaixo aponta para o Python do venv do projeto,
    onde o gpype e todas as dependências estão instaladas.
    Ajusta o caminho se o teu venv estiver noutra localização.
"""
...
class LSLLauncher(QWidget):
    def __init__(self):
        ...
        # Mostra qual Python está a ser usado
        self.python_label = QLabel(f"Python: {sys.executable}")
        self.python_label.setAlignment(Qt.AlignCenter)
        self.python_label.setStyleSheet("font-size: 10px; color: #888; padding: 2px;")
