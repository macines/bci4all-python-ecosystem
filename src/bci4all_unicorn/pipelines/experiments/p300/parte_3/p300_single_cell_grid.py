...
Descrição:
    Camada visual do protótipo P300.
    Grelha 3x3 em que uma célula de cada vez faz flash.

Notas:
    - Só trata da interface visual.
    - O controller externo decide quando iniciar/parar.
    - O callback on_stimulus_start é disparado logo após repaint().
"""
...
class P300SingleCellGrid(Widget):
    def __init__(
        ...
        # callbacks externos
        # on_stimulus_start(idx, is_target, label_text)
    ...
    def _flash_on(self):
        ...
        # força pintura antes do callback externo
